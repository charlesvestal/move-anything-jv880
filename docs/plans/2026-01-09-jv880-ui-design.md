# JV-880 Move UI Design

## Purpose
Implement a full JV-880 front-panel UI on Ableton Move with three states (Play, Edit, Utility), a persistent favorites system, and SysEx-capable UI -> DSP control. The module remains a sound generator only (no sequencer/clip behavior).

## Architecture Summary
- DSP remains the JV-880 emulator and authoritative sound engine.
